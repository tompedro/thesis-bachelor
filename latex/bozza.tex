...
To benefit from the algebraic structure of Lie algebras within the framework of differential geometry, we must introduce manifolds equipped with compatible smooth group operations. In order to canonically endow the tangent space at the identity element with a non-trivial Lie algebra structure induced by left-invariant vector fields, the manifold must globally be a Lie group.
